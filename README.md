<!--
Created by: Karishma Malik
Role: AI / Data Engineering
Project Type: Agentic RAG Proof of Concept
Ownership: Individual developer contribution
Notes:
- Built using open-source libraries and frameworks
- No client-specific, organization-specific, or account-specific identifiers included
- Intended for technical evaluation, experimentation, and learning purposes
-->
